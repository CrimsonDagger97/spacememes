package com.spacememes.levels;

import java.awt.Graphics2D;
import java.util.ArrayList;

import com.spacememes.enemy_types.EnemyType;
import com.spacememes.enemy_types.EnemyTypeBasic;
...
public class Level implements SuperLevel{
	...
	public Level(Player player, EnemyBulletHandler bulletHandler){
		this.player = player;
		this.bulletHandler = bulletHandler;
		addEnemies();
		
		beep = new Sound("/com/spacememes/sounds/beep.wav");
		boop = new Sound("/com/spacememes/sounds/boop.wav");
	}
